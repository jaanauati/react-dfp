module.exports = {
  ...
  plugins: ['eslint-comments', 'eslint-plugin-import', 'flowtype', 'react', 'jest'],
  ...
  rules: {
    // General
    'comma-dangle': [1, 'only-multiline'], // allow or disallow trailing commas
    ...
    // 'import/named': 2, // not found in react-router-native
    ...
    'max-depth': [2, { max: 2 }], // specify the maximum depth that blocks can be nested (off by default)
