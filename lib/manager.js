...
var DfpManager = function DfpManager() {
  ...
  this.setAdSenseAttribute = function (key, value) {
    _this.setAdSenseAttributes(_defineProperty({}, key, value));
  };
  ...
  this.setAdSenseAttributes = async function (values) {
    _this.adSenseAttributes = _extends({}, _this.adSenseAttributes, values);
