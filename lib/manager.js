...
var DFPManager = Object.assign(new _events.EventEmitter().setMaxListeners(0), {
  ...
  getRefreshableSlots: function getRefreshableSlots() {
    ...
    for (var _len = arguments.length, slotsArray = new Array(_len), _key = 0; _key < _len; _key++) {
      slotsArray[_key] = arguments[_key];
    }
    ...
    if (loadAlreadyCalled === false) {
      ...
      this.getGoogletag().then(function (googletag) {
        googletag.cmd.push(function () {
          ...
          pubadsService.refresh(Object.keys(_this4.getRefreshableSlots.apply(_this4, slots)).map(function (slotId) {
  ...
  destroyGPTSlots: function destroyGPTSlots() {
    for (var _len3 = arguments.length, slotsToDestroy = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
      slotsToDestroy[_key3] = arguments[_key3];
    }
