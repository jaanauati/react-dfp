...
var shouldUpdateCorrelator = Utils.correlatorUpdateUrlStrategy;
var DFPManager = Object.assign(new _events.EventEmitter().setMaxListeners(0), {
  ...
  configureCorrelatorRefreshStrategy: function configureCorrelatorRefreshStrategy(func) {
    shouldUpdateCorrelator = func;
  },
  getCorrelatorRefreshStrategyFunction: function getCorrelatorRefreshStrategyFunction() {
  ...
  gptUpdateCorrelator: function gptUpdateCorrelator() {
    return this.getGoogletag().then(function (googletag) {
