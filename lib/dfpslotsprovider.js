...
function (_React$Component) {
  ...
  _createClass(DFPSlotsProvider, [{
    ...
    value: function applyConfigs() {
      _manager.default.configureCorrelatorRefreshStrategy(this.props.shouldUpdateCorrelator);
    ...
    value: function render() {
      var children = _react.default.createElement("div", null, " ", this.props.children, " ");
...
_defineProperty(DFPSlotsProvider, "propTypes", {
  ...
  shouldUpdateCorrelator: _propTypes.default.func
});
...
_defineProperty(DFPSlotsProvider, "defaultProps", {
  ...
  lazyLoad: false,
  shouldUpdateCorrelator: _utils.correlatorUpdateUrlStrategy
});
