...
var DFPSlotsProvider = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = _createSuper(DFPSlotsProvider);
  ...
  function DFPSlotsProvider(props) {
    ...
    _this.loadAdsIfPossible = _this.loadAdsIfPossible.bind(_assertThisInitialized(_this));
    _this.newSlotCallback = _this.newSlotCallback.bind(_assertThisInitialized(_this));
    _this.applyConfigs = _this.applyConfigs.bind(_assertThisInitialized(_this));
    _this.shouldReloadConfig = _this.shouldReloadConfig.bind(_assertThisInitialized(_this));
    _this.attachLoadCallback = _this.attachLoadCallback.bind(_assertThisInitialized(_this));
    ...
    _this.gptLoadErrorCallbackAttached = false;
  ...
  _createClass(DFPSlotsProvider, [{
    ...
    value: function applyConfigs() {
      ...
      _manager["default"].configureLazyLoad(typeof this.props.lazyLoad === 'boolean' ? null : this.props.lazyLoad);
    ...
    key: "attachGPTLoadErrorCallback",
    value: function attachGPTLoadErrorCallback() {
      if (this.gptLoadErrorCallbackAttached === false) {
        _manager["default"].attachGPTLoadError(function handleGPTLoadError(data) {
...
_defineProperty(DFPSlotsProvider, "propTypes", {
  ...
  onGPTScriptLoadError: _propTypes["default"].func
});
