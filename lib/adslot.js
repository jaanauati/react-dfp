...
function (_React$Component) {
  ...
  _createClass(AdSlot, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.sizeMappingRefresh && this.props.sizeMapping && window) {
        var mqls = this.props.sizeMapping.map(function (_ref) {
          var viewport = _ref.viewport;
          return window.matchMedia("(min-width: ".concat(viewport[0], "px) and (min-width: ").concat(viewport[1], "px)"));
        });

        for (var i = 0; i < mqls.length; i++) {
          mqls[i].addListener(function () {
            _manager.default.refresh([_this2.state.slotId]);
          });
        }
      }
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (Object.prototype.hasOwnProperty.call(nextProps, 'objectId')) {
        ...
        var slotId = this.generateSlotId();
        this.unregisterSlot();
...
_defineProperty(AdSlot, "propTypes", {
  ...
  sizeMappingRefresh: _propTypes.default.bool,
